...
cmp r1, #0
beq NoCrit
ldrb r1, [r4, #0x14] @load str stat
ldrh r2, [r7, #6] @final mt
add r0, r2 @add final mt to current damage
sub r0, r1 @subtract str, so you effectively only add weapon mt

NoCrit:
strh r0, [r7, #4] @final damage = 1x + skill stat
